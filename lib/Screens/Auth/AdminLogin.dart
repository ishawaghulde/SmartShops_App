          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  FadeAnimation(1, Text("Admin Login", style: TextStyle(color: Colors.white, fontSize: 40),)),
                  SizedBox(height: 10,),
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        FadeAnimation(1.5, GestureDetector(
                            onTap: ()=> Navigator.pushNamed(context, ADMIN_REGISTER),
                        ...
                        FadeAnimation(1.7, GestureDetector(
                          onTap: ()=> Navigator.pushNamed(context, USER_LOGIN),
                            child: Text("For Customer Login, Click Here!", style: TextStyle(color: Colors.grey[600], fontSize: 15.0),))),
                      ],
                    ),
                  ),
                ),
